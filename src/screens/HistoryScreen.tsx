...
const HistoryScreen = () => {
  ...
  const handleNavigateReadDetail = (bookId: string,chapterId: string) => {
    navigation.navigate('BookReading', { bookId, chapterId });
  };
        ...
        <View style={styles.itemContainer}>
          ...
          <View style={styles.itemDetails}>
            ...
            {selectedTab === 'reading' && chapter && (
              <TouchableOpacity
                activeOpacity={0.7}
                onPress={(e) => handleNavigateReadDetail(book._id,chapter._id)}
              >
                <Text style={styles.chapter}>
                  Chương hiện tại: {chapter.chapterNumber}
                </Text>
              </TouchableOpacity>
            )}
          </View>
